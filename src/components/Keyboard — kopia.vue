  ...
  methods: {
    checkpassword: function () {
      ...
      if (this.password === md5(inputcopy)) {
        ...
        this.changeinfo()
        this.info = 'Poprawne hasło! odblokowałeś nastepne strony'
      } else {
        this.changeinfo()
        this.info = 'Nie poprawne hasło,<br class="mobile"> nie podawaj się!'
      }
      this.input = ''
    },
    changeinfo () {
...
.input-info__container {top: -130px;}
...
@media only screen and (max-width: 1100px) {
  #input-info__text{font-size: 24px!important;}
  #game__keyboard {
...
.input-info__container {top: -80px;}
@keyframes infochange{
...
#input-info__text{font-size: 24px;}
}
...
.input__container{padding: 25px 0px;}
.input__circle{height: 7vw;width: 7vw;margin: 0 0.5vw;}
.input__text{font-size: 18px;}

#input-info__text{font-size: 18px!important;}
}
</style>
